...
$body1 .= "<div class='newsarticle_text'>Welcome to the forums. Please fill in your details below to be given access.</div>";

$table = "<table class='table_of_things' >
			<tr>
				<td class='field_name' >Username <span class='hint' >(Between 4 and 20 characters)</span></td>
			...
			<tr>
				<td class='field_name' >Password <span class='hint' >(Above 5 characters)</span></td>
			...
			<tr>
				<td class='field_name' >Captcha Question:
				 <span class='hint'>Is an apple a fruit or a vegetable</span></td>
				<td><input type='text' class='input' id='user_reg_cap' /></td>
				<td id='reg_cap_res'></td>
			</tr>
			<tr>
				<td class='buttons' id='fin_result' ></td>
				<td class='buttons' >
					<button onclick='submitNewUserData(\".\")' class='button' >Submit</button>
				</td>
			</tr>
		</table>";
